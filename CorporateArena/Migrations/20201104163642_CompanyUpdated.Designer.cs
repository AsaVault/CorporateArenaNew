...
namespace CorporateArena.Presentation.Core.Migrations
{
    ...
    [Migration("20201104163642_CompanyUpdated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CorporateArena.DataAccess.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("companies","arenas");
                });

            modelBuilder.Entity("CorporateArena.DataAccess.Entities.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("questions","arenas");
                });

            modelBuilder.Entity("CorporateArena.DataAccess.Entities.QuestionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("questionanswers","arenas");
                });

            modelBuilder.Entity("CorporateArena.DataAccess.Entities.QuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("questionoptions","arenas");
                });
            ...
            modelBuilder.Entity("CorporateArena.Domain.Core.Entities.JobCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CorporateArena.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateCreated = new DateTime(2020, 11, 4, 17, 36, 40, 641, DateTimeKind.Local).AddTicks(1206),
                        ...
                        {
                            ID = 2,
                            DateCreated = new DateTime(2020, 11, 4, 17, 36, 40, 643, DateTimeKind.Local).AddTicks(6943),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Basic",
                            Name = "Basic",
                            UserCreated = 1
            ...
            modelBuilder.Entity("CorporateArena.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateCreated = new DateTime(2020, 11, 4, 17, 36, 40, 644, DateTimeKind.Local).AddTicks(1263),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("CorporateArena.Domain.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateCreated = new DateTime(2020, 11, 4, 17, 36, 40, 644, DateTimeKind.Local).AddTicks(6651),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleID = 1,
                            UserID = 1
                        });
            ...
            modelBuilder.Entity("CorporateArena.Domain.Vacancy", b =>
                {
                    ...
                    b.Property<string>("JobExperiences")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("KeyPerformance")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CorporateArena.DataAccess.Entities.QuestionAnswer", b =>
                {
                    b.HasOne("CorporateArena.DataAccess.Entities.Question", "Question")
                        .WithMany("QuestionAnswers")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CorporateArena.Domain.User", "User")
            ...
            modelBuilder.Entity("CorporateArena.Domain.Vacancy", b =>
                {
                    b.HasOne("CorporateArena.DataAccess.Entities.Company", "Company")
                        .WithMany("Vacancies")
