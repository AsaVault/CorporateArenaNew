...
namespace CorporateArena.Presentation.Core.Migrations
{
    ...
    [Migration("20201020182651_QuestionAddedToDb")]
    partial class QuestionAddedToDb
    {
            ...
            modelBuilder.Entity("CorporateArena.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateCreated = new DateTime(2020, 10, 20, 19, 26, 50, 420, DateTimeKind.Local).AddTicks(742),
                        ...
                        {
                            ID = 2,
                            DateCreated = new DateTime(2020, 10, 20, 19, 26, 50, 422, DateTimeKind.Local).AddTicks(6873),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Basic",
                            Name = "Basic",
                            UserCreated = 1
            ...
            modelBuilder.Entity("CorporateArena.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateCreated = new DateTime(2020, 10, 20, 19, 26, 50, 423, DateTimeKind.Local).AddTicks(3811),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("CorporateArena.Domain.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateCreated = new DateTime(2020, 10, 20, 19, 26, 50, 424, DateTimeKind.Local).AddTicks(2649),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleID = 1,
                            UserID = 1
                        });
